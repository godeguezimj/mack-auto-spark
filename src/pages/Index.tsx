      ...
      <header className="sticky top-0 z-40 bg-[var(--ink)]/85 backdrop-blur-xl border-b border-white/10">
        <div className="container-x flex items-center justify-between py-4 md:py-5">
          <a href="#top" className="flex items-center gap-2">
            <img src={mackLogo.url} alt="MACK Auto Service" width={204} height={68} className="h-12 md:h-[68px] w-auto object-contain drop-shadow-[0_0_18px_rgba(0,191,255,0.45)]" />
          </a>
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <a
                ...
                className="btn-whats wa-btn-soft inline-flex items-center justify-center gap-2 rounded-md px-7 py-4 font-semibold uppercase tracking-wide text-sm mt-6"
              >
                <span className="wa-breathe"><FaWhatsapp className="h-5 w-5" /></span> Falar com um Mecânico
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="container-x">
          ...
          <div className="mt-8 text-center" data-reveal>
            <a
              ...
              className="btn-whats wa-btn-soft inline-flex items-center gap-2 rounded-xl px-7 py-4 font-bold uppercase tracking-wide"
            >
              <span className="wa-breathe"><FaWhatsapp className="h-5 w-5" /></span> Quero Resolver Esse Problema
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container-x relative py-10 md:py-14">
          <div className="rounded-2xl glass p-6 md:p-10 flex flex-col md:flex-row md:items-center gap-5 md:gap-10 neon-glow">
            ...
            <a
              ...
              className="btn-whats wa-btn-soft inline-flex items-center justify-center gap-2 rounded-xl px-6 py-4 font-bold uppercase tracking-wide text-sm md:text-base whitespace-nowrap"
            >
              <span className="wa-breathe"><FaWhatsapp className="h-5 w-5" /></span> Agendar Check-up
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container-x">
          ...
          <div className="mt-8 text-center">
            <a
              ...
              onClick={() => trackWhats("ver_avaliacoes_google")}
              className="inline-flex items-center gap-2 rounded-full bg-card border-2 border-primary px-6 py-3 text-sm md:text-base font-bold text-primary hover:bg-primary hover:text-primary-foreground transition shadow-sm hover:shadow-md"
            >
